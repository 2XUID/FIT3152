...
#ggsave("hwyvdispla.jpg", g, width = 20, height = 12, units = "cm")
...
g
ggsave("hwyvdispl.jpg", g, width = 20, height = 12, units = "cm")
...
ggsave("hwyvdispltext.jpg", d, width = 20, height = 12, units = "cm")
